...
# Apply customers to be instructors using PUT
...
# Create sports course types with images and prices greater than 0
...
# Create scheduled courses with the correct time format
