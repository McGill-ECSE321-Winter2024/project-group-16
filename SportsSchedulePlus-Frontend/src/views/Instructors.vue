      ...
      <div class="table-responsive p-0">
        <table class="table align-items-center mb-0">
          ...
          <tbody>
            ...
            >
              <!-- Your existing row content here -->
              <td>
              ...
              <td class="align-middle text-center text-sm">
                <span
                  :class="{'badge': true, 'badge-lg': true, 'bg-gradient-success': instructor.personRoleDto.hasApplied === true, 'bg-gradient-secondary':  instructor.personRoleDto.hasApplied  === false}"
                  >{{ instructor.personRoleDto.hasApplied  }}</span
                >
              </td>
